...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'gdc_news', 'title',
                      self.gf('django.db.models.fields.CharField')(default='empty', max_length=30),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'News.title'
        db.delete_column(u'gdc_news', 'title')
    ...
    models = {
        ...
        u'gdc.news': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'posted': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 6, 0, 0)'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '30'})
        }
    }
